...
export function indexReducer(state = initialState, action: any) {
    ...
    } else if (type === 'setSucursalIdSelected') {
        localStorage.setItem('sucursalIdSelected', payload);
        return { ...state, sucursalIdSelected: payload };
    } else if (type === 'setCodActEcoSelected') {
        localStorage.setItem('codActEcoSelected', payload);
        return { ...state, codActEcoSelected: payload };
    }
